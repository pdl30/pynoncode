...
setup(name='pynoncode',
      ...
      scripts=['scripts/pynon_align.py', 'scripts/pynon_anno.py', 'scripts/pynon_count.py', 'scripts/pynon_ucsc.py', 'scripts/pynon_plot.py', 'scripts/pynon_diff.py','scripts/bedGraphToBigWig'],
